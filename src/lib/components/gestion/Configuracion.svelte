                ...
                <div class="config-grid">
                    <div class="col-main">
                        <div class="config-group">
                            <label>Mensaje SMS estudiantes</label>
                            <textarea rows="3" bind:value={config.smsEstudiantes} placeholder="Escriba el mensaje..."></textarea>
                        </div>
                        <div class="config-group">
                            <label>Mensaje SMS coordinadores</label>
                            <textarea rows="3" bind:value={config.smsCoordinadores} placeholder="Escriba el mensaje..."></textarea>
                        </div>
...
<style>
  ...
  /* Botón Guardar Cambios (VERDE como imagen 3) */
  ...
  .config-group textarea { width: 100%; background: var(--input-bg); border: 1px solid var(--border-color); color: var(--text-main); padding: 12px; border-radius: 8px; box-sizing: border-box; }
  ...
  /* --- INFO USUARIO (ESTILO TARJETA BLANCA) --- */
  .user-info-section { 
      grid-column: span 2; 
      background: var(--bg-card); 
      border: 1px solid var(--border-color); 
      border-radius: 8px; /* Bordes ligeramente menos redondeados según imagen */
      padding: 25px; 
      margin-top: 20px; 
      margin-bottom: 40px;
  ...
  .ui-item label::first-letter { text-transform: uppercase; } /* Capitaliza solo la primera letra */
  .ui-item span { font-size: 15px; color: var(--text-main); font-weight: 400; }

  /* --- MODAL (ESTILO IMAGEN 2) --- */
  ...
  .modal-content-user { background: var(--bg-card); border-radius: 8px; width: 800px; box-shadow: 0 10px 30px rgba(0,0,0,0.2); overflow: hidden; border: 1px solid var(--border-color); }
