<script lang="ts">
  ...
  import { SangriaParrafo } from '$lib/extensions/SangriaParrafo'; // Asegúrate de que esta ruta sea correcta en tu proyecto
  ...
  import { 
    ...
    Check, Loader2, Cloud, ChevronsLeft, ChevronsRight, FileSignature
  } from 'lucide-svelte';

  const dispatch = createEventDispatcher();

  // --- ESTADO DE NAVEGACIÓN ---
  let modoEditor = false; // false = viendo tarjetas, true = editando
  let tipoActivo = 'oradores'; // 'oradores', 'presidentes', 'oraciones'
  ...
  // --- DATOS DE MARCADORES (Tus grupos originales) ---
  let markerGroups = [
      {
          title: "Lista rápida de Marcadores", isOpen: true,
          items: [ { label: "Saludo según sexo", desc: "Ejemplo: Hermano, o Hermana", code: "[[Saludo según sexo]]", value: "Saludo según sexo" }, { label: "Designación del Circuito", desc: "Ejemplo: HG-06", code: "[[Designación del Circuito]]", value: "Designación del Circuito" } ]
      },
      {
          title: "Marcadores de Fechas", isOpen: false,
          items: [ { label: "Fecha Actual Mediana", desc: "Ejemplo: 7 feb 2026", code: "[[Fecha Actual Mediana]]", value: "Fecha Actual Mediana" }, { label: "Fecha Actual Completa", desc: "Ejemplo: 7 de febrero de 2026", code: "[[Fecha Actual Completa]]", value: "Fecha Actual Completa" } ]
      },
      {
          title: "Marcadores de Asignación", isOpen: false,
          items: [ { label: "Hora", desc: "Ejemplo: 10:10 AM", code: "[[Hora]]", value: "Hora" }, { label: "Duración", desc: "Total de minutos", code: "[[Duración]]", value: "Duración" }, { label: "Tema", desc: "Título del discurso", code: "[[Tema]]", value: "Tema" }, { label: "Número de Bosquejo", desc: "Ejemplo: 1", code: "[[Número de Bosquejo]]", value: "Número de Bosquejo" }, { label: "Tipo de asignación", desc: "Ejemplo: Discurso...", code: "[[Tipo de asignación]]", value: "Tipo de asignación" }, { label: "Enlace(s) del Bosquejo", desc: "Cualquier enlace", code: "[[Enlace(s) del Bosquejo]]", value: "Enlace(s) del Bosquejo" }, { label: "Notas", desc: "", code: "[[Notas]]", value: "Notas" } ]
      },
      {
          title: "Marcadores de Orador", isOpen: false,
          items: [ { label: "Nombre", desc: "Ejemplo: Roberto", code: "[[Nombre]]", value: "Nombre" }, { label: "Segundo nombre", desc: "Ejemplo: Adolfo", code: "[[Segundo nombre]]", value: "Segundo nombre" }, { label: "Apellidos", desc: "Ejemplo: Batista Peña", code: "[[Apellidos]]", value: "Apellidos" } ]
      },
      {
          title: "Marcadores de Lugar", isOpen: false,
          items: [ { label: "Nombre del lugar", desc: "Ejemplo: Salón", code: "[[Nombre del lugar]]", value: "Nombre del lugar" }, { label: "Dirección del lugar", desc: "Ejemplo: Av. Central", code: "[[Dirección]]", value: "Dirección" }, { label: "Ciudad", desc: "Ejemplo: Holguín", code: "[[Ciudad]]", value: "Ciudad" }, { label: "Provincia o Estado", desc: "Ejemplo: HG", code: "[[Estado o Provincia]]", value: "Estado o Provincia" } ]
      },
      {
          title: "Marcadores de Evento", isOpen: false,
          items: [ { label: "Fecha", desc: "Ejemplo: Fecha de la Asamblea", code: "[[Fecha]]", value: "Fecha" }, { label: "Tipo de evento", desc: "Ejemplo: CA-br", code: "[[Tipo de Evento]]", value: "Tipo de Evento" }, { label: "Tema del evento", desc: "Título del evento", code: "[[Tema del Evento]]", value: "Tema del Evento" } ]
      },
      {
          title: "Marcadores de Ensayo", isOpen: false,
          items: [ { label: "Información completa de los ensayos", desc: "Info completa", code: "[[Información completa de los ensayos]]", value: "Información completa de los ensayos" }, { label: "Nota para los ensayos", desc: "", code: "[[Notas para los ensayos]]", value: "Notas para los ensayos" }, { label: "Lugar de los ensayos", desc: "", code: "[[Lugar de los ensayos]]", value: "Lugar de los ensayos" }, { label: "Fecha y hora del ensayo", desc: "", code: "[[Fecha y hora del ensayo]]", value: "Fecha y hora del ensayo" }, { label: "Fecha de ensayos", desc: "", code: "[[Fecha de ensayos]]", value: "Fecha de ensayos" }, { label: "Hora de ensayos", desc: "", code: "[[Hora de ensayos]]", value: "Hora de ensayos" } ]
      },
      {
          title: "Marcadores del Presidente", isOpen: false,
          items: [ { label: "Correo electrónico del Presidente", desc: "Ejemplo: mail@jwpub.org", code: "[[correo electrónico jwpub del Presidente de la asamblea]]", value: "correo electrónico jwpub del Presidente de la asamblea" }, { label: "Teléfono del Presidente", desc: "", code: "[[Teléfono del Presidente de la asamblea]]", value: "Teléfono del Presidente de la asamblea" } ]
      },
      {
          title: "Marcadores de Instrucciones", isOpen: false,
          items: [ { label: "Información de orientaciones", desc: "Plataforma...", code: "[[Información de orientaciones]]", value: "Información de orientaciones" }, { label: "Instrucciones especiales", desc: "Sucursal", code: "[[Instrucciones Especiales]]", value: "Instrucciones Especiales" } ]
      }
  ];

  // --- COLORES ---
  const themeColors = ['#C00000', '#FF0000', '#FFC000', '#FFFF00', '#92D050', '#00B050', '#00B0F0', '#0070C0', '#002060', '#7030A0', '#595959', '#A6A6A6', '#D9D9D9', '#FFFFFF', '#F2F2F2', '#D0CECE', '#B4C6E7', '#8EA9DB', '#5B9BD5', '#2E75B6', '#1F4E78', '#376092', '#5B9BD5', '#BDD7EE', '#DEEBF7', '#FCE4D6', '#F8CBAD', '#F4B183', '#ED7D31', '#C65911', '#834C11', '#7F6000', '#9CAB7B', '#C6E0B4', '#E2F0D9', '#D7E4BC', '#C5E0B3', '#A9D08E', '#70AD47', '#548235'];
  const standardColors = ['#000000', '#FFFFFF', '#EEECE1', '#1F497D', '#4F81BD', '#C0504D', '#9BBB59', '#8064A2', '#4BACC6', '#F79646'];

  // --- EXTENSIONES TIPTAP CUSTOM ---
  ...
  async function abrirEditor(tipo: string) {
      tipoActivo = tipo;
      modoEditor = true;
      dispatch('cambioModo', true); // Avisa a Configuracion.svelte para ocultar sidebar
      
      // Esperamos a que Svelte renderice el DOM del editor
      await tick();
      iniciarEditor();
  }
  ...
  function cerrarEditor() {
      ...
      modoEditor = false;
      dispatch('cambioModo', false); // Avisa a Configuracion.svelte para mostrar sidebar
  }
  ...
  async function cargarPlantilla() {
    try {
      ...
      else if (editor) editor.commands.setContent(`<p>Plantilla nueva para ${tipoActivo}</p>`);
    }
  }
  ...
  function iniciarEditor() {
    ...
    editor = new Editor({
      ...
      extensions: [
        ...
        SangriaParrafo.configure({ indentStep: 36, maxIndent: 5, firstLineIndent: 36 }),
      ],
      content: '', 
      editorProps: {
...
{#if !modoEditor}
    <div class="cards-container">
        ...
        <div class="info-footer">
            ...
            <span>Seleccione una plantilla para editar su formato y contenido predeterminado.</span>
        </div>
    </div>
    ...
    <div class="word-layout">
        ...
        <aside class="sidebar">
            <div class="sidebar-top">
                <button class="back-btn" on:click={cerrarEditor} title="Volver al menú">
                    <ArrowLeft size={24} />
                </button>
        ...
        <main class="editor-main">
            ...
            <div class="app-header">
                <div class="left-section">
                    ...
                    <div class="doc-info">
                        <span class="doc-title">EDITANDO: {tipoActivo.toUpperCase()}</span>
                    ...
                    <div class="ribbon-group">
                        <div class="group-row">
                            ...
                            <div class="group-col small-gap">
                                <button class="ribbon-btn list-item" on:click={cortar} title="Cortar"><Scissors size={14} /> <span>Cortar</span></button>
                                <button class="ribbon-btn list-item" on:click={copiar} title="Copiar"><Copy size={14} /> <span>Copiar</span></button>
                            </div>
                        </div>
                        ...
                        <div class="group-col full-h">
                            <div class="controls-row">
                                <select class="font-select" on:change={cambiarFuente} bind:value={currentFont} title="Fuente">
                                    <option value="Arial">Arial</option><option value="Calibri">Calibri</option><option value="Times New Roman">Times New Roman</option><option value="Verdana">Verdana</option><option value="Georgia">Georgia</option>
                                </select>
                                <select class="size-select" on:change={cambiarTamano} bind:value={currentSize} title="Tamaño">
                                    <option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="14">14</option><option value="16">16</option><option value="18">18</option><option value="20">20</option><option value="24">24</option><option value="30">30</option>
                                </select>
                                ...
                                <div class="color-picker-wrapper">
                                    ...
                                    {#if isColorPickerOpen}
                                        <div class="color-picker-dropdown" style="top: {colorPickerPos.top}px; left: {colorPickerPos.left}px;">
                                            ...
                                            <div class="color-section"><div class="color-section-title">Colores de Tema</div><div class="color-grid-theme">{#each themeColors as color}<button class="color-swatch-theme" style="background-color: {color}; border: 1px solid {color === '#FFFFFF' ? '#ccc' : 'transparent'};" class:active={currentColor === color} on:click={() => selectColor(color)} title={color}></button>{/each}</div></div>
                                            <div class="color-section"><div class="color-section-title">Colores Estándar</div><div class="color-grid-standard">{#each standardColors as color}<button class="color-swatch-standard" style="background-color: {color}; border: 1px solid {color === '#FFFFFF' ? '#ccc' : 'transparent'};" class:active={currentColor === color} on:click={() => selectColor(color)} title={color}></button>{/each}</div></div>
                                        </div>
                                    {/if}
                                </div>
                            </div>
                        ...
                        <div class="group-col full-h">
                            <div class="controls-row">
                                ...
                                <div class="group-row centered">
                                    <button class="ribbon-btn small" on:click={() => editor.chain().focus().liftListItem('listItem').run()} title="Disminuir nivel" disabled={!editor?.isActive('bulletList') && !editor?.isActive('orderedList')}><IndentDecrease size={18}/></button>
                                    <button class="ribbon-btn small" on:click={() => editor.chain().focus().sinkListItem('listItem').run()} title="Aumentar nivel" disabled={!editor?.isActive('bulletList') && !editor?.isActive('orderedList')}><IndentIncrease size={18}/></button>
                                </div>
                                <div class="divider-v"></div>
                                <div class="group-row centered">
                                    <button class="ribbon-btn small" on:click={() => (editor.chain().focus()).decreaseIndent().run()} title="Disminuir margen"><ChevronsLeft size={18}/></button>
                                    <button class="ribbon-btn small" on:click={() => (editor.chain().focus()).increaseIndent().run()} title="Aumentar margen"><ChevronsRight size={18}/></button>
                                </div>
                                <div class="divider-v"></div>
                                <div class="group-row centered">
                                  <button class="ribbon-btn small" 
                                       on:click={() => (editor.chain().focus() as any).toggleFirstLine().run()} 
                                       title="Sangría 1ra línea">
                    ...
                    <div class="ribbon-group">
                        <div class="group-col full-h margins-group">
                            <div class="margin-row">
                                <div class="margin-input" title="Margen Superior"><ArrowUpFromLine size={12} /><input type="number" step="0.1" bind:value={marginTop} /></div>
                                <div class="margin-input" title="Margen Inferior"><ArrowDownToLine size={12} /><input type="number" step="0.1" bind:value={marginBottom} /></div>
                            </div>
                            <div class="margin-row">
                                <div class="margin-input" title="Margen Izquierdo"><ArrowLeftFromLine size={12} /><input type="number" step="0.1" bind:value={marginLeft} /></div>
                                <div class="margin-input" title="Margen Derecho"><ArrowRightToLine size={12} /><input type="number" step="0.1" bind:value={marginRight} /></div>
                            </div>
                        </div>
...
<style>
/* ==========================================================================
   PLANTILLAS CARTAS - ESTILOS UNIFICADOS (CON HOJA SIEMPRE LEGIBLE)
   ========================================================================== */

/* --- TARJETAS DE SELECCIÓN (PANELES) --- */
.cards-container {
  padding: 0;
  max-width: 1000px;
}
...
.ribbon-group.grow-right {
  flex-grow: 1;
  align-items: flex-end;
  padding-right: 20px;
}
.ribbon-group.ml-auto {
  margin-left: auto;
}
.group-row {
  display: flex;
...
/* Workspace (fondo estilo escritorio) */
.workspace {
  flex: 1;
...
/* --- HOJA DE PAPEL: SIEMPRE BLANCA CON TEXTO NEGRO --- */
.paper-sheet {
  width: 21.59cm;
  min-height: 27.94cm;
...
/* Forzar que todo el contenido del editor sea blanco y negro */
.editor-content,
.editor-content *,
.ProseMirror,
.ProseMirror * {
...
/* Asegurar que el cursor parpadee */
.ProseMirror-cursor {
  border-left: 1px solid black !important;
}

/* Enlaces dentro del editor (azul pero legibles) */
.editor-content a,
.ProseMirror a {
